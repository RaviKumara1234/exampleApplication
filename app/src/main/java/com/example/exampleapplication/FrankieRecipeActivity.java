...
public class FrankieRecipeActivity extends AppCompatActivity {

    private Button addFavoriteButton;
    private DatabaseHelper dbHelper;
    private String recipeName = "Frankie";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frankie);
        ...
        addFavoriteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dbHelper.isRecipeFavorite(recipeName)) {
                    ...
                    Toast.makeText(FrankieRecipeActivity.this, recipeName + " removed from favorites!", Toast.LENGTH_SHORT).show();
                    sendNotification(recipeName + " removed from favorites!");
                } else {
                    dbHelper.addFavoriteRecipe(recipeName);
                    addFavoriteButton.setText("Remove from Favorites");
                    Toast.makeText(FrankieRecipeActivity.this, recipeName + " added to favorites!", Toast.LENGTH_SHORT).show();
    ...
    private void sendNotification(String message) {
        ...
        if (notification != null) {
            notificationManager.notify(19, notification); // Unique ID for Frankie
        }
    }
}
