...
public class FishFryRecipeActivity extends AppCompatActivity {

    private Button addFavoriteButton;
    private DatabaseHelper dbHelper;
    private String recipeName = "Fish Fry";
        ...
        addFavoriteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dbHelper.isRecipeFavorite(recipeName)) {
                    ...
                    Toast.makeText(FishFryRecipeActivity.this, recipeName + " removed from favorites!", Toast.LENGTH_SHORT).show();
                    sendNotification(recipeName + " removed from favorites!");
                } else {
                    dbHelper.addFavoriteRecipe(recipeName);
                    addFavoriteButton.setText("Remove from Favorites");
                    Toast.makeText(FishFryRecipeActivity.this, recipeName + " added to favorites!", Toast.LENGTH_SHORT).show();
    ...
    private void sendNotification(String message) {
        ...
        if (notification != null) {
            notificationManager.notify(18, notification); // Unique ID for Fish Fry
        }
    }
}
