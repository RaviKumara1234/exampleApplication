...
public class VennPongalRecipeActivity extends AppCompatActivity {

    private Button addFavoriteButton;
    private DatabaseHelper dbHelper;
    private String recipeName = "Venn Pongal";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_venn_pongal);
        ...
        addFavoriteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dbHelper.isRecipeFavorite(recipeName)) {
                    ...
                    Toast.makeText(VennPongalRecipeActivity.this, recipeName + " removed from favorites!", Toast.LENGTH_SHORT).show();
                    sendNotification(recipeName + " removed from favorites!");
                } else {
                    // Add to favorites
                    dbHelper.addFavoriteRecipe(recipeName);
                    addFavoriteButton.setText("Remove from Favorites");
                    Toast.makeText(VennPongalRecipeActivity.this, recipeName + " added to favorites!", Toast.LENGTH_SHORT).show();
    ...
    private void sendNotification(String message) {
        ...
        if (notification != null) {
            notificationManager.notify(39, notification); // Unique ID for Venn Pongal
        }
    }
}
