...
public class AppamRecipeActivity extends AppCompatActivity {
    ...
    private static final String CHANNEL_ID = "favorites_channel"; // Same channel ID as others
    ...
    private void sendNotification(String message) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            notification = new Notification.Builder(this, CHANNEL_ID)
                    ...
                    .setSmallIcon(R.mipmap.ic_launcher) // Replace with a custom icon if you have one
                    .setAutoCancel(true)
                    .build();
        }

        if (notification != null) {
            notificationManager.notify(3, notification); // Use unique ID to avoid overwrite
        }
    }
}
