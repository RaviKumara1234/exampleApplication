...
public class CabbageThoranRecipeActivity extends AppCompatActivity {
    ...
    // Method to create notification channel (Android Oreo and above)
    ...
    private void sendNotification(String message) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            notification = new Notification.Builder(this, CHANNEL_ID)
                    ...
                    .setSmallIcon(R.mipmap.ic_launcher) // You can use a better icon here
                    .setAutoCancel(true)
                    .build();
        }

        if (notification != null) {
            notificationManager.notify(8, notification); // Unique notification ID for this activity
        }
    }
}
