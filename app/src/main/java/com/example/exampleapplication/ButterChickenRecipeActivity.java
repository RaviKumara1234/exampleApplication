...
public class ButterChickenRecipeActivity extends AppCompatActivity {

    private Button addFavoriteButton;
    private DatabaseHelper dbHelper;
    private String recipeName = "Butter Chicken";

    private static final String CHANNEL_ID = "favorites_channel"; // Shared channel ID for all recipe notifications
        ...
        addFavoriteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dbHelper.isRecipeFavorite(recipeName)) {
                    ...
                    Toast.makeText(ButterChickenRecipeActivity.this, recipeName + " removed from favorites!", Toast.LENGTH_SHORT).show();
                    sendNotification(recipeName + " removed from favorites!");
                } else {
                    dbHelper.addFavoriteRecipe(recipeName);
                    addFavoriteButton.setText("Remove from Favorites");
                    Toast.makeText(ButterChickenRecipeActivity.this, recipeName + " added to favorites!", Toast.LENGTH_SHORT).show();
    ...
    private void sendNotification(String message) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            notification = new Notification.Builder(this, CHANNEL_ID)
                    ...
                    .setSmallIcon(R.mipmap.ic_launcher) // Replace with custom icon if you have one
                    .setAutoCancel(true)
                    .build();
        }

        if (notification != null) {
            notificationManager.notify(7, notification); // Unique notification ID
        }
    }
}
