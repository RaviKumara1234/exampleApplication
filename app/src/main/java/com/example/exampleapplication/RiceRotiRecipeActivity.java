...
public class RiceRotiRecipeActivity extends AppCompatActivity {

    private Button addFavoriteButton;
    private DatabaseHelper dbHelper;
    private String recipeName = "Rice Roti";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rice_roti);
        ...
        addFavoriteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dbHelper.isRecipeFavorite(recipeName)) {
                    ...
                    Toast.makeText(RiceRotiRecipeActivity.this, recipeName + " removed from favorites!", Toast.LENGTH_SHORT).show();
                    sendNotification(recipeName + " removed from favorites!");
                } else {
                    // Add to favorites
                    dbHelper.addFavoriteRecipe(recipeName);
                    addFavoriteButton.setText("Remove from Favorites");
                    Toast.makeText(RiceRotiRecipeActivity.this, recipeName + " added to favorites!", Toast.LENGTH_SHORT).show();
    ...
    private void sendNotification(String message) {
        ...
        if (notification != null) {
            notificationManager.notify(33, notification); // Unique ID for Rice Roti
        }
    }
}
